...
$(function(){
	var mapid = 0;
	$(".footer .showMap").click(function(){
		if(mapid == 0){
			$(".footer a").css("color","#000000").removeClass("fa-angle-double-up").addClass("fa-angle-double-down");
			$(".footer iframe").css("height","600px");
			$(".footer iframe").css("opacity","1");
			$(".hideMap").css("display","none");
			$('html,body').animate({scrollTop:$('body').height()+500}, 1000);
			mapid = 1;
		}
		else{
			$(".footer a").css("color","#FFFFFF").removeClass("fa-angle-double-down").addClass("fa-angle-double-up");
			$(".footer iframe").css("height","300px");
			$(".footer iframe").css("opacity","0.1");
	...
	$(window).scroll(function () { 
	 	if ($(window).scrollTop() > 400) { 
	 		$(".fl_top").css("display","block");
	 	}
	 	else $(".fl_top").css("display","none");
	})
