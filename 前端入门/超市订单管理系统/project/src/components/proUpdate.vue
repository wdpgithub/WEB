		...
		<div class="providerAdd">
            <form action="#">
                ...
                <div class="">
                    ...
                    <input type="text" readonly="readonly" name="providerId" id="providerId" ref="procode" :value="singleProInfor.procode"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="providerName">供应商名称：</label>
                    <input type="text" name="providerName" id="providerName" ref="providerName" :placeholder="singleProInfor.providerName"/>
                    <span >*</span>
                </div>
                <div>
                    <label for="people">联系人：</label>
                    <input type="text" name="people" id="people" ref="people" :placeholder="singleProInfor.people"/>
                    <span>*</span>

                </div>
                <div>
                    <label for="phone">联系电话：</label>
                    <input type="text" name="phone" id="phone" ref="phone" :placeholder="singleProInfor.phone"/>
                    <span></span>
                </div>
                <div>
                    <label for="address">联系地址：</label>
                    <input type="text" name="address" id="address" ref="address" :placeholder="singleProInfor.address"/>
                    <span></span>

                </div>
                <div>
                    <label for="fax">传真：</label>
                    <input type="text" name="fax" id="fax" ref="fax" :placeholder="singleProInfor.fax"/>
                    <span></span>

                </div>
                <div>
                    <label for="describe">描述：</label>
                    <input type="text" name="describe" id="describe" ref="describe" :placeholder="singleProInfor.describe"/>
                    <span></span>
                ...
                <div class="providerAddBtn">
                    ...
                    <input type="button" value="保存" @click="updatePro"/>
                    <input type="button" value="返回" @click="proUpdateBack(false)"/>
                </div>
            </form>
        </div>
	</div>
...
<script>
	...
	export default{
		store,
		computed:{
			...mapState(['singleProInfor','showProInfor'])
		},
		methods:{
			...mapMutations(['proUpdateBack']),
			updatePro(){
				...
				var _this=this
				this.$axios({
					url:'/VueHandler/provider?action=update',
					method:'post',
					data:{
						procode:procode,
