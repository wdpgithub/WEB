/*
* @Author: Marte
* @Date:   2018-07-25 15:09:27
* @Last Modified by:   Marte
* @Last Modified time: 2018-07-25 15:09:30
*/
            ...
            var e = t(this)
              ...
              , o = function() {
                var t = []
                  ...
                  , i = /[0-9]+,[0-9]+/.test(o);
                o = o.replace(/,/g, "");
                for (var l = (/^[0-9]+$/.test(o),
                /^[0-9]+\.[0-9]+$/.test(o)), u = l ? (o.split(".")[1] || []).length : 0, s = n; s >= 1; s--) {
                    var a = parseInt(o / n * s);
                    if (l && (a = parseFloat(o / n * s).toFixed(u)),
                    i)
                ...
                var c = function() {
                    ...
                    e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), r.delay) : (delete e.data("counterup-nums"),
    ...
    !function(t, e) {
        ...
        i = function() {
            function t(t) {
                ...
                t.bind(v, function() {
                    var t;
                    return e.didScroll || f ? void 0 : (e.didScroll = !0,
                    t = function() {
                        return e.doScroll(),
                        e.didScroll = !1
                    }
            ...
            return t.prototype.doScroll = function() {
                ...
                !f || t.vertical.oldScroll && t.vertical.newScroll || n[w]("refresh"),
            ...
            t.prototype.refresh = function() {
                var t, e, r, o = this;
                return r = n.isWindow(this.element),
                ...
                n.each(t, function(t, e) {
                    return n.each(o.waypoints[t], function(t, r) {
                        var o, i, l, u, s;
                        return o = r.options.offset,
                        l = r.offset,
                        i = n.isWindow(r.element) ? 0 : r.$element.offset()[e.offsetProp],
                        ...
                        r.offset = i - e.contextOffset + e.contextScroll - o,
                        r.options.onlyOnScroll && null != l || !r.enabled ? void 0 : null !== l && l < (u = e.oldScroll) && u <= r.offset ? r.trigger([e.backward]) : null !== l && l > (s = e.oldScroll) && s >= r.offset ? r.trigger([e.forward]) : null === l && e.oldScroll >= r.offset ? r.trigger([e.forward]) : void 0
                    })
                })
            }
            ,
        ...
        l = function() {
            function t(t, e, r) {
                var o, i;
                r = n.extend({}, n.fn[m].defaults, r),
                "bottom-in-view" === r.offset && (r.offset = function() {
                    var t;
                    return t = n[w]("viewportHeight"),
            ...
            t.prototype.destroy = function() {
                return delete u[this.axis][this.id],
            ...
            t.getWaypointsByElement = function(t) {
                var e, r;
                return (r = n(t).data(g)) ? (e = n.extend({}, u.horizontal, u.vertical),
                n.map(r, function(t) {
                    return e[t]
                })) : []
            }
        ...
        h = {
            init: function(t, e) {
                var r;
                return null == e && (e = {}),
                null == (r = e.handler) && (e.handler = t),
                this.each(function() {
                    var t, r, o, u;
                    return t = n(this),
                    o = null != (u = e.context) ? u : n.fn[m].defaults.context,
                    n.isWindow(o) || (o = t.closest(o)),
                    o = n(o),
                    r = c[o.data(a)],
                    r || (r = new i(o)),
                    new l(t,r,e)
            ...
            _invoke: function(t, e) {
                return t.each(function() {
                    var t;
                    return t = l.getWaypointsByElement(this),
        ...
        d = {
            ...
            aggregate: function(t) {
                var e, r, o;
                return e = u,
                t && (e = null != (o = c[n(t).data(a)]) ? o.waypoints : void 0),
                e ? (r = {
                    horizontal: [],
                    vertical: []
                },
            ...
            _invoke: function(t) {
                var e;
                return e = n.extend({}, u.vertical, u.horizontal),
            ...
            _filter: function(t, e, r) {
                var o, i;
                return (o = c[n(t).data(a)]) ? (i = [],
                n.each(o.waypoints[e], function(t, e) {
        ...
        n[w] = function() {
            ...
            t = 2 <= arguments.length ? e.call(arguments, 1) : [],
            d[n] ? d[n].apply(null, t) : d.aggregate.call(null, n)
        }
        ,
        n[w].settings = {
            resizeThrottle: 100,
